...
if(isset($_GET['user_profile'])){
	...
	$row_admin=mysli_fetch_aray($run_admin);
...
<div class='row'><!-- Row 1 Start-->
	<div class='col-lg-12'>
		<ol class='breadcrumb'>
			<li class='active'>
				<i class='fa fa-dashboard'></i>Dasboard /Edit Profile
			</li>
		</ol>
	</div>
	</div><!-- Row 1 close-->
				...
				<div class='panel-heading'>
					...
					<form class='form-horizontal' action='' method='post' enctype='multipart/form-data'>
						...
						<div class='form-group'>
							...
							<div class='col-md-6'>
						<textarea type='text' name='admin_about' class='form-control' rows='3'> 
						...
						<div class='form-group'>
							...
							<div class='col-md-6'>
						<input type='text' name='admin_image' class='form-control' required="" >		<br>
						<img src="admin_images/<?php echo $admin_iamge; ?> " width="70" height="70">
							</div>
						</div>
...
move_uploaded_file($temp_admin_image,"product_images/$admin_image");
