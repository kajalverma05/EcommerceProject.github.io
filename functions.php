...
{
	global $db;
	$get_product="select * from products  LIMIT 0,15";
	...
	while($row_product=mysqli_fetch_array($run_product)){
		...
		echo "
		  <div class='col-md-4 col-sm-6'>
		    <div class='product' style='width:290px;height:400px'>
		    <a href='details.php?pro_id=$pro_id'>
		    <img src='admin_area/product_images/$pro_img1' class='img-responsive' style='height:250px;width:290px' >
		    </a>
		    <div class='text'>
